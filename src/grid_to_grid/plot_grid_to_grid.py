...
if __name__ == "__main__":
    ...
    # generate the plots of all the raw fields and diffs for the grid_to_grid use case results generated by running
    # the anom.conf file.
    ...
    #      nc_diff_var = DIFF_TMP_P850_FULL    which are obtained by performing an 'ncdump' on the netcdf file and
    #      and assigning the variable names exactly as they are displayed in the ncdump output.
    # The 'var' is set to the variable name ie. TMP, UGRD, VGRD, HGT, etc...and is used as a prefix to the output file
