...
class Hist(BasePlot):
    ...
    def __init__(self, parameters: dict) -> None:
        ...
        # instantiate a HistogramConfig object, which holds all the necessary
        # settings from the
    ...
    def _perform_event_equalization(self):
        ...
        if len(self.config_obj.series_val_names) > 0:
            input_df_ee = None
            all_fields_values_orig = self.config_obj.get_config_value(
                'series_val_1').copy()
            all_fields_values = {}
            ...
            for field_name, field_value in all_fields_values.items():
                for val in field_value:
                    ...
                    series_data_after_ee = event_equalize(series_data_for_ee,
                                                          "fcst_valid_beg",
                                                          {}, fix_vals_keys,
            ...
            input_df_ee = event_equalize(self.input_df, "fcst_valid_beg", {},
                                         fix_vals_keys,
    ...
    def _create_series(self, input_data):
        """
           Generate all the ser objects that are to be displayed as specified by the
           plot_disp
           ...
           Args:
               input_data:  The input data in the form of a Pandas dataframe.
                            This data will be subset to reflect the ser data of
                            interest.
        ...
        for i, name in enumerate(self.config_obj.get_series_y()):
            ...
            series_obj = hist_series_type(self.config_obj, ind, input_data, series_list,
                                          name)
