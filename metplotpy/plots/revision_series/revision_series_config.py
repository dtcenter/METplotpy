...
"""
Class Name: revision_series_config.py
...
class RevisionSeriesConfig(Config):
    def __init__(self, parameters: dict) -> None:
        """ Reads in the plot settings from a RevisionSeries plot config file.
    ...
    def get_series_y(self) -> list:
        ...
        """
        if self.get_config_value('series_val_1') is not None:
            all_fields_values_orig = all_fields_values_orig = self.get_config_value('series_val_1').copy()
        else:
