...
def generate_plot(input_nc_file_dir, input_nc_filename, fhr, variable_name,
    ...
    :param level_type :  the letter indicating the type of level
                        (ie P for pressure level, Z for height above ground)
...
def main():
    ...
    for file_info in file_info_list:
        ...
        generate_plot(input_dir, input_file, hour, variable_name, level_type, level,
