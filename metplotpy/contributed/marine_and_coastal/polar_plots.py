...
#-------------------------------------------------------
def process_one_day(hemisphere):
    ...
    plot_config_file = os.getenv("YAML_CONFIG_NAME","polar_plot.yaml")
    input_file = met_grid_stat_ice 
    ...
    obs_ice=ice_data.OBS_ice_coverage_SURFACE_FULL[:-1,:-1,]
    fcst_ice=ice_data.FCST_ice_coverage_SURFACE_FULL[:-1,:-1,]
    model_name = ice_data.model
    obtype_name = ice_data.obtype
    init_time = ice_data.FCST_ice_coverage_SURFACE_FULL.init_time
