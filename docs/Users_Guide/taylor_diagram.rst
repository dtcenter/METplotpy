...
**minimal_taylor_diagram.yaml** file (anywhere below the comment block):
...
* A **taylor_diagram_custom.png** output file will be created in
  ...
  in the **custom_taylor_diagram.yaml** config file.
