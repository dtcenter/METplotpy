...
MPR linetype column names specified in the Point-Stat section of the MET User's Guide in `Table 11.20 <https://metplus.readthedocs.io/projects/met/en/latest/Users_Guide/point-stat.html#table-ps-format-info-seeps>`_ "Format information for SEEPS (Stable Equitable Error in Probability Space) output line type".
