...
def run_example(config_file):
    ...
    config = open_config(config_file)
    command_str = "python " +  config['source_dir'] + "/planview_fv3.py " + " ./fv3_physics_tend_defaults.yaml " +  config['history_file'] + " " + config['grid_file'] + " tmp pbl -p 500 -t 6 -v 20190504T21 --nofineprint "
