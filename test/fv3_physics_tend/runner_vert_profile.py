...
def run_example(config_file):
    ...
    command_str = "python " + config['source_dir'] + "/vert_profile_fv3.py " + " ./fv3_physics_tend_defaults.yaml " + \
                  config['history_file'] + " " + config[
                      'grid_file'] + " tmp -t 1 -v 20190615T20 -s "  + shapefiles_dir +  " --nofineprint "
...
def run_example(config_file):
    ...
    command_str = "python " + config['source_dir'] + "/vert_profile_fv3.py " + " ./fv3_physics_tend_defaults.yaml " + \
                  config['history_file'] + " " + config[
                      'grid_file'] + " tmp -t 1 -v 20190615T20 -s " + shapefile_dir + " --nofineprint"
    print("command string: ", command_str)
    os.system(command_str)
...
def run_with_novel_output_file(config_file):
    ...
    command_str = "python " + config['source_dir'] + "/vert_profile_fv3.py " + " ./fv3_physics_tend_defaults.yaml " + \
                  config['history_file'] + " " + config[
                      'grid_file'] + " tmp -t 1 -v 20190615T20 -s " + shapefile_dir + " -o ./test_vert_profile.png --nofineprint"
    print("command string: ", command_str)
    os.system(command_str)
...
def run_with_novel_output_dir(config_file):
    ...
    command_str = "python " + config['source_dir'] + "/vert_profile_fv3.py " + " ./fv3_physics_tend_defaults.yaml " + \
                  config['history_file'] + " " + config[
                      'grid_file'] + " tmp -t 1 -v 20190615T20 -s " + shapefile_dir + " -o ./output/test_vert_profile.png --nofineprint"
    print("command string: ", command_str)
    os.system(command_str)
