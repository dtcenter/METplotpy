...
def setup():
    ...
    custom_config_filename = "custom_revision_box.yaml"
...
def cleanup():
    ...
    try:
        path = os.getcwd()
        plot_file = 'revision_box.png'
        points_file_1 = 'revision_box.points1'
...
def test_images_match(setup):
    ...
    """
    comparison = CompareImages('./revision_box_expected.png', './revision_box.png')
...
def test_files_exist(test_input, expected):
    ...
    try:
        ...
        pass
    os.environ['METPLOTPY_BASE'] = "../../"
    custom_config_filename = "custom2_revision_box.yaml"
